...
const CartPage = () => {
  ...
  <section className=" container max-w-screen-xl m-auto grid grid-cols-12 gap-8 my-16 ">
      ...
      <table className="w-full">
        ...
        <tbody>
          <tr className="*:py-4 *:text-center">
            ...
            <img src="https://mcdn.coolmate.me/image/March2023/meme-meo-cute-hai-huoc-1297_438.jpg" className="w-[77px] inline mr-4" alt="Mèo dễ thương" />
    ...
    <div className="col-span-4 bg-neutral-100 p-8">
      ...
      <Link to="" className="border border-solid border-yellow-500 text-yellow-500 w-full inline-block text-center py-2 hover:bg-yellow-600 hover:text-white">Checkout</Link>
    </div>
  </section>
</main>
