  ...
  <section className="mt-16">
    <div className="grid grid-cols-2 gap-8 mb-16">
      <div className="grid grid-cols-6 gap-8">
        <div className="col-span-1 *:mb-4">
          <img src="https://toigingiuvedep.vn/wp-content/uploads/2022/04/hinh-anh-meo-khoc-buon-cute.jpg" alt="" />
          <img src="https://toigingiuvedep.vn/wp-content/uploads/2022/04/hinh-anh-meo-khoc-buon-cute.jpg" alt="" />
          <img src="https://toigingiuvedep.vn/wp-content/uploads/2022/04/hinh-anh-meo-khoc-buon-cute.jpg" alt="" />
          <img src="https://toigingiuvedep.vn/wp-content/uploads/2022/04/hinh-anh-meo-khoc-buon-cute.jpg" alt="" />
          <img src="https://toigingiuvedep.vn/wp-content/uploads/2022/04/hinh-anh-meo-khoc-buon-cute.jpg" alt="" />
      ...
      <div>
        ...
        <p className="font-medium my-4">Setting the bar as one of the loudest speakers in its class, the Kilburn is a compact, stout-hearted hero with a well-balanced audio which boasts a clear midrange and extended highs for a sound.
        </p>
        <div>
    ...
    <div>
      <div className="*:font-semibold *:text-xl *:mr-16 border-b pb-4 mb-8">
        ...
        <Link to=" " className="text-[#A3A3A3]">Additional Information</Link>
        <Link to=" " className="text-[#A3A3A3]">Reviews [5]</Link>
      </div>
      <div className="*:text-[#A3A3A3] *:font-medium  ">
        ...
        <div className="flex gap-8 *:mt-8 ">
          <img src="ghe.png"  className="w-[624px]" alt="" />
          <img src="ghe1.jpg" className="w-[624px]" alt =""/>
        </div>
      </div>
    </div>
  </section>
    ...
    <div className="grid grid-cols-4 gap-8">
      <div>
        <div className="overflow-hidden">
          <img src="https://inkythuatso.com/uploads/thumbnails/800/2023/01/meme-meo-khoc-thet-6-27-09-41-23.jpg" alt className="hover:scale-125 duration-1000 " />
        </div>
